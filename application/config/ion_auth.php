...
*/
$config['tables']['users']           = 'prefix_users';
$config['tables']['groups']          = 'prefix_groups';
$config['tables']['users_groups']    = 'prefix_users_groups';
$config['tables']['login_attempts']  = 'prefix_login_attempts';
 ...
 */
$config['site_title']           = "Site Title"; 		// Site Title, example.com
$config['admin_email']          = "info@asiamarketingsolutions.com"; 	// Admin Email, admin@example.com
